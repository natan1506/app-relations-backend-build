declare module '@ioc:Adonis/Lucid/Orm' {
    import { ScopeFn, LucidRow, LucidModel, HooksDecorator, ColumnDecorator, ComputedDecorator, DateColumnDecorator, ModelPaginatorContract, DateTimeColumnDecorator } from '@ioc:Adonis/Lucid/Model';
    ...
    export { NamingStrategyContract, ModelQueryBuilderContract, ModelPaginatorContract, } from '@ioc:Adonis/Lucid/Model';
    ...
    export const ModelPaginator: {
        ...
        new <Row extends LucidRow>(rows: Row[], total: number, perPage: number, currentPage: number): ModelPaginatorContract<Row>;
    };
    /**
